            ...
            <div class="row">
                <div class="col-12">
                    ...
                    @foreach($categories as $category)
                        <div>
                            <a href="{{ route('home.index', ['category' => $category->id]) }}" class="category-box wow fadeInUp">
                                <div>
                        ...
                        <div>
                            <div class="product-box-4 wow fadeInUp">
                                ...
                                <div class="product-detail">
                                    ...
                                    <h5 class="price theme-color">{{ $product->product_price }}</del></h5>
                    ...
                    <div class="slider-4-1 ratio_65 no-arrow product-wrapper">
                        <div>
                            <div class="product-slider wow fadeInUp">
                                <a href="shop-left-sidebar.html" class="product-slider-image">
                                    <img src="{{ asset('frontend/assets/images/veg-2/pro/1.jpg')}}" class="w-100 blur-up lazyload rounded-3"
                                        alt="">
                                </a>
                        ...
                        <div>
                            <div class="product-slider wow fadeInUp" data-wow-delay="0.05s">
                                <a href="shop-left-sidebar.html" class="product-slider-image">
                                    <img src="{{ asset('frontend/assets/images/veg-2/pro/2.jpg')}}" class="w-100 blur-up lazyload rounded-3"
                                        alt="">
                                </a>
                        ...
                        <div>
                            <div class="product-slider wow fadeInUp" data-wow-delay="0.1s">
                                <a href="shop-left-sidebar.html" class="product-slider-image">
                                    <img src="{{ asset('frontend/assets/images/veg-2/pro/3.jpg')}}" class="w-100 blur-up lazyload rounded-3"
                                        alt="">
                                </a>
                        ...
                        <div>
                            <div class="product-slider wow fadeInUp" data-wow-delay="0.15s">
                                <a href="shop-left-sidebar.html" class="product-slider-image">
                                    <img src="{{ asset('frontend/assets/images/veg-2/pro/4.jpg')}}" class="w-100 blur-up lazyload rounded-3"
                                        alt="">
                                </a>
                    ...
                    <div class="slider-5 ratio_87">
                            ...
                            <div class="blog-box">
                                <div class="blog-box-image">
                                    <a href="blog-detail.html" class="blog-image">
                                        <img src="{{ asset('frontend/assets/images/veg-2/blog/1.jpg')}}" class="bg-img blur-up lazyload"
                                            alt="">
                                    </a>
                                </div>
                        ...
                        <div>
                            <div class="blog-box">
                                <div class="blog-box-image">
                                    <a href="blog-detail.html" class="blog-image">
                                        <img src="{{ asset('frontend/assets/images/veg-2/blog/2.jpg')}}" class="bg-img blur-up lazyload"
                                            alt="">
                                    </a>
                                </div>
                        ...
                        <div>
                            <div class="blog-box">
                                <div class="blog-box-image">
                                    <a href="blog-detail.html" class="blog-image">
                                        <img src="{{ asset('frontend/assets/images/veg-2/blog/3.jpg')}}" class="bg-img blur-up lazyload"
                                            alt="">
                                    </a>
                                </div>
                        ...
                        <div>
                            <div class="blog-box">
                                <div class="blog-box-image">
                                    <a href="blog-detail.html" class="blog-image">
                                        <img src="{{ asset('frontend/assets/images/veg-2/blog/4.jpg')}}" class="bg-img blur-up lazyload"
                                            alt="">
                                    </a>
                                </div>
                        ...
                        <div>
                            <div class="blog-box">
                                <div class="blog-box-image">
                                    <a href="blog-detail.html" class="blog-image">
                                        <img src="{{ asset('frontend/assets/images/veg-2/blog/5.jpg')}}" class="bg-img blur-up lazyload"
                                            alt="">
                                    </a>
                                </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-fullscreen-sm-down">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Choose your Delivery Location 1111</h5>
