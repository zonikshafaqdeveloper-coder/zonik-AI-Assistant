        ...
        <div class="row">
            ...
            <div class="col-md-4 my-2">
                ...
                <div class="d-flex mt-3 social align-items-center">
                    ...
                    <p class="paragraph hide-mobile">Unit no.42 (Near Panchal Furniture), Nav Nandanvan Industrial estate, Asha Nagar,(Landmark:Gold Gym mulund west) Mulund West,Mumbai 400080,India <br>
...
function updateQuantity(type, id) {
  ...
  $('.box-btn, .loose-btn').removeClass('active');
    $('.pcs-box').hide();
    $('.quantity').removeAttr('data-quantity');
    ...
    $(`.product-${id}`).attr('data-quantity', type);
}
...
function submit(productId) {
    ...
    let quantityData = $(`.product-${productId}`).attr('data-quantity');
...
$(document).ready(function () {
    ...
    $('.owl-carousel-offers').each(function () {
        ...
        $owl.owlCarousel({
            ...
            autoplay: itemCount > visibleItems,
            autoplayTimeout: 5000,
            autoplayHoverPause: true,
            responsive: {
                0: {
