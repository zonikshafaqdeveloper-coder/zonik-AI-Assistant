                    ...
                    <div class="col-md-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="forms-sample" action="{{ route('order.update', $orders->id) }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="payment_method">Total Amount To be Paid</label>
                                                <input type="text" class="form-control" name="paid_amount" value="{{ $orders->total_discount_value }}" readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control form-select" id="payment_status" name="payment_status">
                                                    ...
                                                    <option value="unpaid" @if($orders->payment_status == 'unpaid') selected @endif>Unpaid</option>
                                                     <option value="partial" @if($orders->payment_status == 'partial') selected @endif>Partial</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="number" class="form-control" name="amount_paid" step="0.01" value="{{ $payment_detail->amount_paid }}">
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label>Upload Payment Proof (Image / PDF)</label>
                                                <input type="file" name="documents[]" multiple class="form-control">
                                                <small class="text-muted">You can upload: JPG, PNG, PDF</small>
                                            </div>
                                        </div>
