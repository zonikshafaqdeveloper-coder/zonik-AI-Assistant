                ...
                <div class="col-sm-8 m-auto">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="theme-form theme-form-2 mega-form" action="{{ route('tag.update', $tag->id) }}" method="POST" >
                            @csrf
                            @method('PUT')
                           ...
                           <div class="mb-4 row align-items-center">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <select class="js-example-basic-single w-100" name="subcategory_id" id="subcategory_id" value="{{$tag->subcategory->name}}">
                               ...
                               <div class="mb-4 row align-items-center">
                                    ...
                                    <div class="col-sm-9">
                                        <input class="form-control" type="text" name="tag_name"
                                         placeholder="Brand name" value="{{$tag->tag_name}}">
                                    </div>
                                </div>
