                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex justify-content-between">
                                            ...
                                            <a href="{{ route('clientsserve.create') }}" type="button"
                                                class="btn btn-primary">Add Client Serve Logo</a>
                                        </div>
                                                    ...
                                                    @foreach ($clientserve as $key => $category)
                                                        <tr>
                                                            ...
                                                            <td style="display:flex; gap: 20px;">
                                                                ...
                                                                <a href="{{ route('clientserve.edit', $category->id) }}"
                                                                    class="align-items-center btn btn-success category-btn d-flex">Edit</a>

                                                                <form method="POST"
                                                                    action="{{ url('delete-clientslogo/' . $category->id) }}">
                                                                    @csrf
                                                                    @method('delete')
