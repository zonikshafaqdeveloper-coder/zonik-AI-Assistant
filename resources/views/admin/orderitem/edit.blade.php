                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control form-select" id="payment_method" name="payment_method">
                                                    <option value="paid" @if($orders->payment_method == 'paid') selected @endif>Paid</option>
                                                    <option value="credit" @if($orders->payment_method == 'credit') selected @endif>Credit</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
