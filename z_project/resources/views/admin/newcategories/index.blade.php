                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex justify-content-between">
                                            ...
                                            <a href="{{ route('categoriess.create') }}" type="button"
                                        ...
                                        <div class="table-responsive">
                                            <table id="category1" class="table table-bordered">
                                                    ...
                                                    @foreach ($categories as $key => $category)
                                                        <tr>
                                                            ...
                                                            <td class="text-center" style="display:flex; gap: 20px;">
                                                                ...
                                                                <a href="{{ route('categoriess.edit', $category->id) }}"
                                                                    class="align-items-center btn btn-success category-btn d-flex">Edit</a>

                                                                <form method="POST"
                                                                    action="{{ url('delete-categoriess/' . $category->id) }}">
                                                                    @csrf
                                                                    @method('delete')
