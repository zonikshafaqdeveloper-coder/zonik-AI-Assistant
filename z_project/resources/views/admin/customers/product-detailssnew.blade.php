                            ...
                            <div class="col-lg-12 grid-margin stretch-card">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="mb-3">
                                        <a href="{{ route('export.enquiry', request()->all()) }}" class="btn btn-success">
                                       ✔ Export To Excel
                                         </a>
                                        </div>
                                        <h5>
            ...
            <tr>
                ...
                <td>
                    <input type="number" class="offer-input"
                        onkeyup="validateDecimal(this); EnquiryOfferPrice(this.value, {{ $enquiry->product->cost_per_item ?? 0 }}, 'result{{ $key + 1 }}')"
               ...
               <td style="
                    @if ($enquiry->status == 'pending' && $enquiry->offer_check == '1') color:red !important;
                    @elseif($enquiry->status == 'pending' && $enquiry->offer_check != '1') color:purple !important;
                    @elseif($enquiry->status == 'submitted') color:green !important;
                    @elseif($enquiry->status == 'rejected') color:orange !important;
                    @endif
                ">
