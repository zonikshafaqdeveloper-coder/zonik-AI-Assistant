                    ...
                    <div class="col-md-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form method="POST" action="{{ route('pincode.store') }}" enctype="multipart/form-data">
                                    @csrf
                                    <!-- CSRF protection -->
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <div class="col-sm-9">
                                                <select name="zone_id" id="zone_id"
                                                    ...
                                                    <option value="{{ $zone->id }}" @if(old('zone_id')==$zone->id)
                                        ...
                                        <div class="form-group col-md-6 ">
                                            ...
                                            <div class="col-sm-9">
                                                <input id="pincode"
                                                    ...
                                                    type="text" name="pincode" value="{{ old('pincode') }}"
                                                    placeholder="Pincode">
                                                    @if(session('pincode'))
                                                    <div class="alert alert-danger">
                                                        {{ session('pincode') }}
