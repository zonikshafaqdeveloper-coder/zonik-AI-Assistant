                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-4">
                                <h3 class="mb-0">Edit Lead Customer</h3>
                            ...
                            <form id="leadCustomerForm">
                                <input type="hidden" id="lead_id" value="{{ $leadCustomer->id }}">

                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        <label class="form-label">Customer Name <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" id="customer_name" name="customer_name" value="{{ $leadCustomer->customer_name }}">
                                    </div>

                                    <div class="col-md-6">
                                        <label class="form-label">Outlet Name <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" id="outlet_name" name="outlet_name" value="{{ $leadCustomer->outlet_name }}">
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="location_cluster" name="location_cluster" value="{{ $leadCustomer->location_cluster }}">
                                    </div>

                                    <div class="col-md-6">
                                        <label class="form-label">Area <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" id="area" name="area" value="{{ $leadCustomer->area }}">
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-12">
                                        ...
                                        <textarea class="form-control" id="address" name="address" rows="2">{{ $leadCustomer->address }}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-4">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="mobile_number" name="mobile_number" maxlength="15" value="{{ $leadCustomer->mobile_number }}">
                                    </div>

                                    <div class="col-md-6">
                                        <label class="form-label">Payment Term (Days) <span class="text-danger">*</span></label>
                                        <input type="number" class="form-control" id="payment_term" name="payment_term" min="0" step="0.01" value="{{ $leadCustomer->payment_term }}">
                                    </div>
                                </div>
                                 ...
                                 <div class="row mb-4">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="outbound_sale_name" name="outbound_sale_name" value="{{ $leadCustomer->outbound_sale_name }}">
                                    </div>

                                    <div class="col-md-6">
                                        <label class="form-label">Inbound Account Lead <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" id="inbound_account_lead" name="inbound_account_lead" value="{{ $leadCustomer->inbound_account_lead }}">
                                    </div>
                                </div>


                                <div class="d-flex gap-2">
                                    <button type="button" class="btn btn-success" id="updateLeadBtn">
