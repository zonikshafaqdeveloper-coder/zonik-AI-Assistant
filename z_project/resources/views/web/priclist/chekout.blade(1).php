...
<div class="co-page">
    <div class="co-container">
        ...
        <!-- ===== Delivery Date Selection (real slots from controller) ===== -->
        <div class="co-card">
            <div class="co-card-label">Select Delivery Date</div>
            <div class="co-delivery-select" id="deliverySelect">
                <div class="co-delivery-select-left">
                    ...
                    <span id="deliveryOptionLabel">Select Delivery Date</span>
                </div>
                ...
                <div class="co-delivery-options" id="deliveryOptionsList">
                    @foreach($deliveryOptions as $option)
                        <div class="co-delivery-option" data-date="{{ $option['date'] }}" data-time="{{ $option['time_only'] }}">
                            {{ $option['slot'] }}
                        </div>
                    @endforeach
                </div>
...
$(document).ready(function () {
    ...
    $('#deliverySelect').on('click', function (e) {
        e.stopPropagation();
        $(this).toggleClass('open');
        $('#deliveryOptionsList').toggleClass('open');
    });

    $(document).on('click', function () {
        $('#deliverySelect').removeClass('open');
        $('#deliveryOptionsList').removeClass('open');
    });

    $('#deliveryOptionsList').on('click', '.co-delivery-option', function (e) {
        e.stopPropagation();
        const date = $(this).data('date');
        const time = $(this).data('time');

        $('#deliveryOptionLabel').text($(this).text().trim());
