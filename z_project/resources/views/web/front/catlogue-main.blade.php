...
<body class="">
                                                ...
                                                <div class="middle-box">
                                                    <div class="location-box">
                                                        <button type="submit" data-bs-toggle="modal"
                                                            ...
                                                            <i class="fa-solid fa-plus"> login/Sing Up</i>
                                                        </button>
            ...
            <div class="row mt-5 mb-5">
                <div class="col-md-4">
                    <div class="catalogue-left-bar">
                        <ul>
                            <li><img src="assets/images/c1.png" class="catalogue-img"><strong style="cursor:pointe;"
                                    onclick="reload()" class="cursor-pointer"> ALL </strong></li>
                            @foreach ($subcategories as $subcategory)
                                <li><img src="/uploads/{{ $subcategory->image }}" class="catalogue-img">
                    ...
                    <div class="filters">
                        <div class="page-wrap">
                            ...
                            <section>
                                        ...
                                        <li role="presentation" class="d-flex ">
                                            ...
                                            @foreach ($tags as $item)
                                                <div class="type-filter rounded-pill fs-6 shadow-lg p-2 px-3">
                                                    <div
                                                        onclick="tagValue({{ $item->id }}, {{ $selectedCategoryId }})">
                                                        {{ $item->tag_name }}</div>
                                                </div>
                                            @endforeach
                                            ...
                                            @if ($brands1)
                                                <div class="modal-body" style="height: 300px;">
                                                    ...
                                                    @foreach ($brands1 as $brand)
                                                        <div
                                                            class="d-flex justify-content-between border-bottom gap-4 mb-2">
                                                            <label for="{{ $brand->id }}">
                                                                {{ $brand->name }}
                                                            </label>
                                                            <input id="{{ $brand->id }}"
                                                                class="form-check-input brand-checkbox"
                                                                type="checkbox" name="brand_list"
                                                                value="{{ $brand->id }}"
                                ...
                                <div class="modal fade" id="exampleModalScrollableTypes" tabindex="-1"
    ...
    <div class="cookie-bar-box">
        <div class="cookie-box">
            <div class="cookie-image">
                <img src="{{ asset('frontweb/assets/images/cookie-bar.png') }}" class="blur-up lazyload"
                    alt="">
                <h2>Cookies!</h2>
            </div>
    ...
    <div class="modal location-modal fade theme-modal" id="locationModal" tabindex="-1"
        ...
        <div class="modal-dialog modal-dialog-centered modal-fullscreen-sm-down">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Choose your Delivery Location 6666</h5>
    ...
    <script>
        var selectedSubCategoryId = {{ $selectedSubCategoryId ?? 'null' }}; // Assuming it's a Blade variable
